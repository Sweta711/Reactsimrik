...
const whatsappNumber = "9779848076466"; // <-- put your number here (without +)
...
>
    ...
    "
    >
        <span className="wave-animation absolute inset-0 rounded-full"></span>
        <FaWhatsapp className="text-white text-3xl sm:text-[34px] z-10" />
    </div>
</a>
);
};
